...
from utils.sampling import mnist_iid, mnist_noniid, cifar_iid, skin_iid
...
if __name__ == '__main__':
    ...
    if args.dataset == 'mnist':
        ...
        if args.iid:
            dict_users = skin_iid(dataset_train, args.num_users)    # write a skin_iid function in sampling.py
        else:
            exit('Error: only consider IID setting in CIFAR10')
    else:
